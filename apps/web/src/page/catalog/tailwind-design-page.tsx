      ...
      <div className="grid grid-cols-5 overflow-hidden rounded-xl border border-border sm:grid-cols-10">
        {Object.entries(scale).map(([step, color]) => (
          <div className="grid gap-2 p-2" key={step} style={{ background: color }}>
            ...
            <span className="font-mono text-caption text-content-title/55">
              {color}
            </span>
          </div>
        ))}
  ...
  return (
    ...
    >
      <div className="mx-auto grid w-full max-w-7xl gap-8">
        <header className="relative overflow-hidden rounded-3xl border border-border bg-card p-6 shadow-lg sm:p-8 lg:p-10">
          ...
          <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
            <div>
              <h1 className="text-display">{theme.name}</h1>
